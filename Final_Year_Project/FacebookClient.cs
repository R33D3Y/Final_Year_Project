...
namespace ConsoleApplication
{
    ...
    public class FacebookClient : IFacebookClient
    {
        ...
        {
            var response = Task.Run(() => _httpClient.GetAsync($"{endpoint}?access_token={accessToken}&{args}")).Result;
        ...
        public async Task PostAsync(string accessToken, string endpoint, object data, string args = null)
        {
            ...
            _ = Task.Run(() => _httpClient.PostAsync($"{endpoint}?access_token={accessToken}&{args}", payload));
        }
